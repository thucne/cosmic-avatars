...
export const SPACE_ICONS: SpaceIcon[] = [
  ...
  // ── Solar System & Planetary (9 new) ──────────────────────────────────────
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="cmt-nucleus" cx="8" cy="24" r="7" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="35%" stop-color="#7DD3FC"/><stop offset="70%" stop-color="#0284C7"/><stop offset="100%" stop-color="#0369A1" stop-opacity="0"/></radialGradient><linearGradient id="cmt-dust" x1="8" y1="24" x2="28" y2="4" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FEF08A" stop-opacity="0.95"/><stop offset="40%" stop-color="#F59E0B" stop-opacity="0.7"/><stop offset="85%" stop-color="#B45309" stop-opacity="0.2"/><stop offset="100%" stop-color="#78350F" stop-opacity="0"/></linearGradient><linearGradient id="cmt-ion" x1="8" y1="24" x2="30" y2="8" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#00F0FF" stop-opacity="0.9"/><stop offset="60%" stop-color="#3B82F6" stop-opacity="0.5"/><stop offset="100%" stop-color="#1E1B4B" stop-opacity="0"/></linearGradient></defs><path d="M8 24 Q18 20 28 4 Q22 14 8 24 Z" fill="url(#cmt-dust)"/><path d="M8 24 L30 8 L24 14 Z" fill="url(#cmt-ion)"/><path d="M8 24 L29 7" stroke="#38BDF8" stroke-width="0.8" stroke-dasharray="1.5 1" opacity="0.8"/><circle cx="8" cy="24" r="6.5" fill="url(#cmt-nucleus)"/><circle cx="8" cy="24" r="2.5" fill="#FFFFFF"/><path d="M6 23C7 21 9 21 10 22C10.5 23.5 9.5 25 8 25C6.5 25 5.5 24 6 23Z" fill="#CBD5E1" stroke="#475569" stroke-width="0.5"/><circle cx="8" cy="23" r="0.6" fill="#334155"/></svg>`
  },
  {
    id: 'great-red-spot',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="jup-grs-bg" cx="12" cy="10" r="14" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FEF08A"/><stop offset="35%" stop-color="#F59E0B"/><stop offset="70%" stop-color="#B45309"/><stop offset="100%" stop-color="#451A03"/></radialGradient><radialGradient id="grs-eye" cx="19" cy="19" r="6.5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FECDD3"/><stop offset="35%" stop-color="#EF4444"/><stop offset="70%" stop-color="#B91C1C"/><stop offset="100%" stop-color="#450A0A"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="url(#jup-grs-bg)"/><path d="M3 9.5C8 8.5 16 8.5 29 9.5M3 13.5C9 12.2 20 12.2 29 13.5M3 22.5C7 23.8 21 23.8 29 22.5" stroke="#78350F" stroke-width="1.2" opacity="0.65"/><path d="M3 11.5C10 10.8 19 10.8 29 11.5M3 15.5C8 14.8 22 14.8 29 15.5" stroke="#FEF3C7" stroke-width="1" opacity="0.45"/><ellipse cx="19" cy="19" rx="6.5" ry="4" fill="url(#grs-eye)" stroke="#F87171" stroke-width="0.8"/><ellipse cx="19" cy="19" rx="3.8" ry="2.2" fill="#991B1B"/><ellipse cx="19" cy="19" rx="1.8" ry="1" fill="#FEF2F2" opacity="0.8"/><path d="M12 17C14 15 16 16 19 15" stroke="#FDE047" stroke-width="0.8" fill="none" opacity="0.65"/><path d="M13 21C15 22.5 18 22 21 23" stroke="#FDE047" stroke-width="0.8" fill="none" opacity="0.65"/></svg>`
  },
  {
    id: 'asteroid-belt',
    name: 'Asteroid Belt',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="ab-sun" cx="16" cy="16" r="4.5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#FDE047"/><stop offset="100%" stop-color="#F97316"/></radialGradient><linearGradient id="rock-shade" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#E2E8F0"/><stop offset="60%" stop-color="#64748B"/><stop offset="100%" stop-color="#1E293B"/></linearGradient></defs><circle cx="16" cy="16" r="4.5" fill="url(#ab-sun)"/><ellipse cx="16" cy="16" rx="13" ry="8" stroke="#38BDF8" stroke-width="0.7" stroke-dasharray="1.5 2" fill="none" opacity="0.4" transform="rotate(-15 16 16)"/><ellipse cx="16" cy="16" rx="10" ry="6" stroke="#94A3B8" stroke-width="0.5" stroke-dasharray="1 1.5" fill="none" opacity="0.3" transform="rotate(-15 16 16)"/><polygon points="4,13 7,10 9,13 7,16" fill="url(#rock-shade)" stroke="#CBD5E1" stroke-width="0.5"/><polygon points="23,19 27,17 28,21 25,23" fill="url(#rock-shade)" stroke="#CBD5E1" stroke-width="0.5"/><polygon points="12,7 15,5 17,8 14,9" fill="url(#rock-shade)" stroke="#CBD5E1" stroke-width="0.5"/><polygon points="15,24 18,22 20,25 17,27" fill="url(#rock-shade)" stroke="#CBD5E1" stroke-width="0.5"/><circle cx="27" cy="11" r="1.2" fill="#CBD5E1"/><circle cx="5" cy="20" r="1" fill="#94A3B8"/><circle cx="21" cy="7" r="1.1" fill="#CBD5E1"/><circle cx="10" cy="25" r="1.3" fill="#94A3B8"/></svg>`
  },
  {
    id: 'solar-cme',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="cme-sun-core" cx="16" cy="30" r="14" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="35%" stop-color="#FDE047"/><stop offset="70%" stop-color="#F97316"/><stop offset="100%" stop-color="#7C2D12"/></radialGradient><linearGradient id="cme-loop-grad" x1="10" y1="24" x2="26" y2="4" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FEF08A"/><stop offset="50%" stop-color="#F97316"/><stop offset="100%" stop-color="#EF4444"/></linearGradient></defs><path d="M2 30A14 14 0 0 1 30 30" fill="url(#cme-sun-core)"/><path d="M7 25C7 13 25 3 25 3C25 3 29 18 19 25" fill="none" stroke="url(#cme-loop-grad)" stroke-width="2.8" stroke-linecap="round"/><path d="M7 25C7 13 25 3 25 3C25 3 29 18 19 25" fill="none" stroke="#FEF08A" stroke-width="1" stroke-linecap="round" opacity="0.85"/><path d="M15 14C12 9 18 3 23 4" stroke="#FFFFFF" stroke-width="1.2" stroke-linecap="round" fill="none"/><circle cx="25" cy="3" r="2" fill="#FEF08A"/><path d="M23 1L27 5M27 1L23 5" stroke="#F97316" stroke-width="0.8"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="rad-core" cx="16" cy="16" r="4" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#00F0FF"/><stop offset="100%" stop-color="#3B82F6" stop-opacity="0"/></radialGradient><linearGradient id="m-trail-1" x1="16" y1="16" x2="29" y2="3" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="40%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669" stop-opacity="0"/></linearGradient><linearGradient id="m-trail-2" x1="16" y1="16" x2="4" y2="28" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="40%" stop-color="#FDE047"/><stop offset="100%" stop-color="#D97706" stop-opacity="0"/></linearGradient></defs><line x1="16" y1="16" x2="29" y2="3" stroke="url(#m-trail-1)" stroke-width="2" stroke-linecap="round"/><line x1="16" y1="16" x2="4" y2="28" stroke="url(#m-trail-2)" stroke-width="2" stroke-linecap="round"/><line x1="16" y1="16" x2="30" y2="12" stroke="#38BDF8" stroke-width="1.5" stroke-linecap="round" opacity="0.8"/><line x1="16" y1="16" x2="2" y2="20" stroke="#F97316" stroke-width="1.5" stroke-linecap="round" opacity="0.8"/><line x1="16" y1="16" x2="27" y2="27" stroke="#A78BFA" stroke-width="1.2" stroke-linecap="round" opacity="0.7"/><line x1="16" y1="16" x2="5" y2="5" stroke="#34D399" stroke-width="1.2" stroke-linecap="round" opacity="0.7"/><circle cx="16" cy="16" r="4" fill="url(#rad-core)"/><circle cx="16" cy="16" r="1.5" fill="#FFFFFF"/><circle cx="29" cy="3" r="1.2" fill="#FFFFFF"/><circle cx="4" cy="28" r="1.2" fill="#FFFFFF"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="transit-star-bg" cx="14" cy="14" r="13" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFBEB"/><stop offset="50%" stop-color="#FDE047"/><stop offset="85%" stop-color="#F59E0B"/><stop offset="100%" stop-color="#B45309"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="url(#transit-star-bg)" stroke="#FDE047" stroke-width="0.8"/><line x1="2" y1="16" x2="30" y2="16" stroke="#78350F" stroke-width="0.8" stroke-dasharray="1.5 1.5" opacity="0.5"/><circle cx="12" cy="16" r="3.5" fill="#030712"/><circle cx="12" cy="16" r="4.2" stroke="#00F0FF" stroke-width="0.8" opacity="0.85"/><circle cx="12" cy="16" r="5" stroke="#38BDF8" stroke-width="0.5" opacity="0.4"/></svg>`
  },
  {
    id: 'sunspot-group',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="spot-star" cx="16" cy="16" r="13" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFF5C0"/><stop offset="50%" stop-color="#FEF08A"/><stop offset="85%" stop-color="#F59E0B"/><stop offset="100%" stop-color="#B45309"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="url(#spot-star)"/><path d="M10 10 Q16 7 22 13" stroke="#B45309" stroke-width="1" stroke-dasharray="1 1" fill="none" opacity="0.7"/><ellipse cx="11" cy="12" rx="4.2" ry="3.2" fill="#78350F"/><ellipse cx="11" cy="12" rx="2.4" ry="1.7" fill="#1C0A00"/><ellipse cx="21" cy="17" rx="5" ry="3.8" fill="#78350F"/><ellipse cx="21" cy="17" rx="3" ry="2.2" fill="#1C0A00"/><ellipse cx="12" cy="22" rx="2.5" ry="1.8" fill="#92400E"/><ellipse cx="12" cy="21" rx="1.3" ry="0.9" fill="#1C0A00"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="dipole-p" cx="14" cy="14" r="6" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#38BDF8"/><stop offset="60%" stop-color="#0284C7"/><stop offset="100%" stop-color="#0F172A"/></radialGradient></defs><path d="M16 10C16 5 21 2 24 5C27 8 27 15 25 19C23 23 18 26 16 22" stroke="#00F0FF" stroke-width="1.4" fill="none"/><path d="M16 10C16 5 11 2 8 5C5 8 5 15 7 19C9 23 14 26 16 22" stroke="#00F0FF" stroke-width="1.4" fill="none"/><path d="M16 8C16 3 24 0 28 4C32 8 31 18 28 23C25 28 19 30 16 24" stroke="#7DD3FC" stroke-width="0.8" fill="none" opacity="0.65"/><path d="M16 8C16 3 8 0 4 4C0 8 1 18 4 23C7 28 13 30 16 24" stroke="#7DD3FC" stroke-width="0.8" fill="none" opacity="0.65"/><line x1="16" y1="1" x2="16" y2="31" stroke="#FDE047" stroke-width="0.8" stroke-dasharray="2 2" opacity="0.6"/><circle cx="16" cy="16" r="5.5" fill="url(#dipole-p)" stroke="#60A5FA" stroke-width="1"/></svg>`
  },
  {
    id: 'polar-aurora',
    name: 'Polar Aurora',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="aurora-curtain-1" x1="0" y1="0" x2="0" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#A78BFA" stop-opacity="0.9"/><stop offset="40%" stop-color="#34D399" stop-opacity="0.85"/><stop offset="100%" stop-color="#059669" stop-opacity="0"/></linearGradient><linearGradient id="aurora-curtain-2" x1="0" y1="0" x2="0" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#38BDF8" stop-opacity="0.9"/><stop offset="50%" stop-color="#34D399" stop-opacity="0.8"/><stop offset="100%" stop-color="#0F172A" stop-opacity="0"/></linearGradient></defs><path d="M2 28A14 14 0 0 1 30 28" fill="#0F172A" stroke="#1E293B" stroke-width="0.8"/><path d="M3 24 Q8 10 16 14 Q24 18 29 10 L29 25 L3 25 Z" fill="url(#aurora-curtain-1)"/><path d="M4 22 Q10 6 18 12 Q24 16 28 8 L28 25 L4 25 Z" fill="url(#aurora-curtain-2)" opacity="0.8"/><line x1="7" y1="24" x2="8" y2="8" stroke="#6EE7B7" stroke-width="1" opacity="0.7"/><line x1="13" y1="24" x2="14" y2="10" stroke="#6EE7B7" stroke-width="1" opacity="0.7"/><line x1="19" y1="24" x2="20" y2="12" stroke="#C084FC" stroke-width="1" opacity="0.7"/><line x1="25" y1="24" x2="26" y2="7" stroke="#6EE7B7" stroke-width="1" opacity="0.7"/><circle cx="8" cy="5" r="0.7" fill="#FFFFFF"/><circle cx="22" cy="4" r="0.7" fill="#FFFFFF"/></svg>`
  },
  ...
  // ── Galaxies & Structure (9 new) ───────────────────────────────────────────
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="hoag-core-grad" cx="16" cy="16" r="5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="45%" stop-color="#FDE047"/><stop offset="85%" stop-color="#F59E0B"/><stop offset="100%" stop-color="#78350F"/></radialGradient><radialGradient id="hoag-ring-glow" cx="16" cy="16" r="14" gradientUnits="userSpaceOnUse"><stop offset="70%" stop-color="#00F0FF" stop-opacity="0"/><stop offset="88%" stop-color="#00F0FF" stop-opacity="0.8"/><stop offset="100%" stop-color="#3B82F6" stop-opacity="0"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="url(#hoag-ring-glow)"/><circle cx="16" cy="16" r="13" stroke="#00F0FF" stroke-width="2.2"/><circle cx="16" cy="16" r="13" stroke="#FFFFFF" stroke-width="0.8" stroke-dasharray="2 3"/><circle cx="16" cy="16" r="4.5" fill="url(#hoag-core-grad)"/><circle cx="16" cy="16" r="1.8" fill="#FFFFFF"/><g fill="#67E8F9"><circle cx="3" cy="16" r="1.2"/><circle cx="29" cy="16" r="1.2"/><circle cx="16" cy="3" r="1.2"/><circle cx="16" cy="29" r="1.2"/></g></svg>`
  },
  {
    id: 'cigar-galaxy',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="m82-core-disk" x1="3" y1="16" x2="29" y2="16" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#78350F"/><stop offset="35%" stop-color="#F59E0B"/><stop offset="50%" stop-color="#FFFFFF"/><stop offset="65%" stop-color="#F59E0B"/><stop offset="100%" stop-color="#78350F"/></linearGradient><linearGradient id="m82-jet-top" x1="16" y1="16" x2="16" y2="2" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#EF4444" stop-opacity="0.95"/><stop offset="60%" stop-color="#F97316" stop-opacity="0.7"/><stop offset="100%" stop-color="#00F0FF" stop-opacity="0"/></linearGradient><linearGradient id="m82-jet-bot" x1="16" y1="16" x2="16" y2="30" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#EF4444" stop-opacity="0.95"/><stop offset="60%" stop-color="#F97316" stop-opacity="0.7"/><stop offset="100%" stop-color="#00F0FF" stop-opacity="0"/></linearGradient></defs><polygon points="16,16 11,2 21,2" fill="url(#m82-jet-top)"/><polygon points="16,16 11,30 21,30" fill="url(#m82-jet-bot)"/><ellipse cx="16" cy="16" rx="13.5" ry="3.5" fill="url(#m82-core-disk)" stroke="#FDE047" stroke-width="0.8"/><ellipse cx="16" cy="16" rx="13.5" ry="1.2" fill="#0F172A" opacity="0.75"/></svg>`
  },
  {
    id: 'cartwheel-galaxy',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="cw-core" cx="16" cy="16" r="4.5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="60%" stop-color="#FDE047"/><stop offset="100%" stop-color="#D97706"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="none" stroke="#F59E0B" stroke-width="2.2"/><circle cx="16" cy="16" r="13" stroke="#FEF08A" stroke-width="0.8" stroke-dasharray="1.5 2"/><line x1="16" y1="11.5" x2="16" y2="3" stroke="#FDE047" stroke-width="1.2"/><line x1="16" y1="20.5" x2="16" y2="29" stroke="#FDE047" stroke-width="1.2"/><line x1="11.5" y1="16" x2="3" y2="16" stroke="#FDE047" stroke-width="1.2"/><line x1="20.5" y1="16" x2="29" y2="16" stroke="#FDE047" stroke-width="1.2"/><line x1="12.8" y1="12.8" x2="6.8" y2="6.8" stroke="#F59E0B" stroke-width="1"/><line x1="19.2" y1="19.2" x2="25.2" y2="25.2" stroke="#F59E0B" stroke-width="1"/><line x1="19.2" y1="12.8" x2="25.2" y2="6.8" stroke="#F59E0B" stroke-width="1"/><line x1="12.8" y1="19.2" x2="6.8" y2="25.2" stroke="#F59E0B" stroke-width="1"/><circle cx="16" cy="16" r="4.5" fill="url(#cw-core)"/></svg>`
  },
  {
    id: 'tadpole-galaxy',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="tad-head" cx="10" cy="12" r="7.5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="45%" stop-color="#38BDF8"/><stop offset="85%" stop-color="#0284C7"/><stop offset="100%" stop-color="#0C4A6E"/></radialGradient><linearGradient id="tad-tail" x1="10" y1="12" x2="30" y2="28" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#38BDF8" stop-opacity="0.95"/><stop offset="60%" stop-color="#0284C7" stop-opacity="0.6"/><stop offset="100%" stop-color="#0F172A" stop-opacity="0"/></linearGradient></defs><path d="M10 12 Q18 20 30 28 Q24 22 10 12 Z" fill="url(#tad-tail)"/><path d="M10 12 Q18 20 30 28" stroke="#7DD3FC" stroke-width="1.8" stroke-linecap="round"/><ellipse cx="10" cy="12" rx="7.5" ry="5.5" fill="url(#tad-head)" stroke="#7DD3FC" stroke-width="0.8"/><circle cx="10" cy="12" r="2.2" fill="#FFFFFF"/><circle cx="20" cy="20" r="1.2" fill="#E0F2FE"/><circle cx="26" cy="25" r="1" fill="#E0F2FE"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="ant-core-1" cx="10" cy="14" r="5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="60%" stop-color="#FDE047"/><stop offset="100%" stop-color="#D97706"/></radialGradient><radialGradient id="ant-core-2" cx="20" cy="18" r="5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="60%" stop-color="#F97316"/><stop offset="100%" stop-color="#991B1B"/></radialGradient></defs><path d="M10 14 C4 8 2 3 4 2" stroke="#F59E0B" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M20 18 C26 24 28 29 26 30" stroke="#EF4444" stroke-width="2" stroke-linecap="round" fill="none"/><ellipse cx="10" cy="14" rx="5.5" ry="4" fill="url(#ant-core-1)" stroke="#FEF08A" stroke-width="0.8" transform="rotate(-20 10 14)"/><ellipse cx="20" cy="18" rx="5.5" ry="4" fill="url(#ant-core-2)" stroke="#FCA5A5" stroke-width="0.8" transform="rotate(20 20 18)"/><path d="M13 14 C15 13 17 15 17 17" stroke="#FFFFFF" stroke-width="1.8" stroke-linecap="round" fill="none"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="lent-bulge" cx="16" cy="16" r="6" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="45%" stop-color="#FDE047"/><stop offset="85%" stop-color="#F59E0B"/><stop offset="100%" stop-color="#78350F" stop-opacity="0"/></radialGradient></defs><ellipse cx="16" cy="16" rx="14" ry="6.5" fill="#78350F" stroke="#F59E0B" stroke-width="1.2"/><ellipse cx="16" cy="16" rx="14" ry="1.8" fill="#030712"/><ellipse cx="16" cy="16" rx="7" ry="6.5" fill="url(#lent-bulge)"/><circle cx="16" cy="16" r="2.5" fill="#FFFFFF"/></svg>`
  },
  {
    id: 'globular-cluster',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="gc-dense-core" cx="16" cy="16" r="13" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="30%" stop-color="#FEF08A"/><stop offset="65%" stop-color="#F59E0B" stop-opacity="0.7"/><stop offset="100%" stop-color="#0F172A" stop-opacity="0"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="url(#gc-dense-core)"/><g fill="#FFFFFF"><circle cx="16" cy="16" r="2"/><circle cx="14" cy="14" r="1.5"/><circle cx="18" cy="14" r="1.5"/><circle cx="13" cy="17" r="1.5"/><circle cx="19" cy="17" r="1.5"/><circle cx="15" cy="20" r="1.2"/><circle cx="17" cy="19" r="1.2"/><circle cx="11" cy="13" r="1.1"/><circle cx="21" cy="13" r="1.1"/><circle cx="10" cy="17" r="1"/><circle cx="22" cy="17" r="1"/><circle cx="13" cy="21" r="1"/><circle cx="19" cy="21" r="1"/><circle cx="8" cy="11" r="0.8"/><circle cx="24" cy="11" r="0.8"/><circle cx="7" cy="16" r="0.8"/><circle cx="25" cy="16" r="0.8"/></g></svg>`
  },
  {
    id: 'open-cluster',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="oc-wisps" cx="16" cy="14" r="12" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#00F0FF" stop-opacity="0.45"/><stop offset="60%" stop-color="#3B82F6" stop-opacity="0.25"/><stop offset="100%" stop-color="#0F172A" stop-opacity="0"/></radialGradient></defs><circle cx="16" cy="14" r="12" fill="url(#oc-wisps)"/><g fill="#FFFFFF"><circle cx="15" cy="8" r="2.2"/><circle cx="21" cy="10" r="2"/><circle cx="20" cy="16" r="2"/><circle cx="14" cy="18" r="1.8"/><circle cx="9" cy="14" r="1.8"/><circle cx="11" cy="10" r="1.5"/></g><path d="M15 4V12M11 8H19" stroke="#E0F2FE" stroke-width="0.7"/><g fill="#67E8F9"><circle cx="25" cy="8" r="1"/><circle cx="6" cy="7" r="1"/><circle cx="26" cy="20" r="1"/><circle cx="5" cy="22" r="1"/></g></svg>`
  },
  {
    id: 'cosmic-void',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="void-bubble" cx="16" cy="16" r="11" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#030712"/><stop offset="70%" stop-color="#0F172A"/><stop offset="100%" stop-color="#38BDF8" stop-opacity="0.5"/></radialGradient></defs><circle cx="16" cy="16" r="11" fill="url(#void-bubble)" stroke="#38BDF8" stroke-width="1" stroke-dasharray="2 2"/><path d="M4 5L12 2L21 3L28 8L30 17L28 25L20 30L11 30L3 24L2 15Z" fill="none" stroke="#818CF8" stroke-width="1.2" opacity="0.85"/><g fill="#A5B4FC"><circle cx="4" cy="5" r="1.5"/><circle cx="12" cy="2" r="1.5"/><circle cx="21" cy="3" r="1.5"/><circle cx="28" cy="8" r="1.5"/><circle cx="30" cy="17" r="1.5"/><circle cx="28" cy="25" r="1.5"/><circle cx="20" cy="30" r="1.5"/><circle cx="11" cy="30" r="1.5"/><circle cx="3" cy="24" r="1.5"/><circle cx="2" cy="15" r="1.5"/></g></svg>`
  },
  ...
  // ── Stars & Nebulae (13 new) ───────────────────────────────────────────────
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="pil-body" x1="0" y1="32" x2="0" y2="0" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#1C0A00"/><stop offset="45%" stop-color="#78350F"/><stop offset="80%" stop-color="#D97706"/><stop offset="100%" stop-color="#FEF08A"/></linearGradient></defs><path d="M4 32C4 24 5 18 7 13C8 9 10 9 10 13V32Z" fill="url(#pil-body)" stroke="#F59E0B" stroke-width="0.6"/><path d="M12 32C12 21 13 13 14 7C15 3 17 3 17 7C17 11 18 19 18 32Z" fill="url(#pil-body)" stroke="#F59E0B" stroke-width="0.6"/><path d="M20 32C20 25 21 21 22 17C23 13 25 13 25 17V32Z" fill="url(#pil-body)" stroke="#F59E0B" stroke-width="0.6"/><circle cx="27" cy="4" r="2" fill="#FFFFFF"/><path d="M27 0V8M23 4H31" stroke="#FEF08A" stroke-width="0.7"/></svg>`
  },
  {
    id: 'horsehead-nebula',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="ic434-bg" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#F43F5E"/><stop offset="50%" stop-color="#E11D48"/><stop offset="100%" stop-color="#881337"/></linearGradient></defs><rect x="2" y="2" width="28" height="28" rx="4" fill="url(#ic434-bg)"/><path d="M2 30V23C2 23 8 22 11 19C13 17 14 13 16 13C18 13 20 15 19 17C20 16 22 15 24 16C26 17 25 19 23 20C24 21 24 24 21 25C19 25.5 16 26 16 30Z" fill="#030712" stroke="#1E293B" stroke-width="0.8"/><circle cx="25" cy="6" r="2.2" fill="#FFFFFF"/><path d="M25 2V10M21 6H29" stroke="#FEF08A" stroke-width="0.7"/></svg>`
  },
  {
    id: 'butterfly-nebula',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="bf-wing-l" cx="6" cy="16" r="11" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FEF08A"/><stop offset="45%" stop-color="#F97316"/><stop offset="85%" stop-color="#EC4899" stop-opacity="0.8"/><stop offset="100%" stop-color="#4C1D95" stop-opacity="0"/></radialGradient><radialGradient id="bf-wing-r" cx="26" cy="16" r="11" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FEF08A"/><stop offset="45%" stop-color="#F97316"/><stop offset="85%" stop-color="#EC4899" stop-opacity="0.8"/><stop offset="100%" stop-color="#4C1D95" stop-opacity="0"/></radialGradient></defs><path d="M16 13C11 8 2 5 2 16C2 27 11 24 16 19 Z" fill="url(#bf-wing-l)" stroke="#F97316" stroke-width="0.8"/><path d="M16 13C21 8 30 5 30 16C30 27 21 24 16 19 Z" fill="url(#bf-wing-r)" stroke="#F97316" stroke-width="0.8"/><ellipse cx="16" cy="16" rx="2.8" ry="5" fill="#0F172A" stroke="#475569" stroke-width="1"/><circle cx="16" cy="16" r="1.8" fill="#FFFFFF"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="ppd-disk-grad" cx="16" cy="16" r="13" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="25%" stop-color="#FDE047"/><stop offset="60%" stop-color="#F97316"/><stop offset="100%" stop-color="#451A03" stop-opacity="0"/></radialGradient></defs><ellipse cx="16" cy="16" rx="14" ry="7" fill="url(#ppd-disk-grad)" transform="rotate(-15 16 16)"/><ellipse cx="16" cy="16" rx="11" ry="5.5" stroke="#0F172A" stroke-width="1.8" fill="none" transform="rotate(-15 16 16)"/><ellipse cx="16" cy="16" rx="7" ry="3.5" stroke="#0F172A" stroke-width="1.5" fill="none" transform="rotate(-15 16 16)"/><circle cx="16" cy="16" r="3" fill="#FFFFFF"/><circle cx="16" cy="16" r="3" stroke="#FEF08A" stroke-width="0.8"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="snr-bg-glow" cx="16" cy="16" r="13" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#00F0FF" stop-opacity="0.8"/><stop offset="40%" stop-color="#EF4444" stop-opacity="0.6"/><stop offset="85%" stop-color="#7C2D12" stop-opacity="0.3"/><stop offset="100%" stop-color="#0F172A" stop-opacity="0"/></radialGradient></defs><path d="M16 3C22 2 28 6 29 12C30 18 27 25 22 28C17 31 9 29 5 24C1 19 2 11 7 6C10 3 13 3 16 3Z" fill="url(#snr-bg-glow)"/><path d="M16 3C22 2 28 6 29 12C30 18 27 25 22 28C17 31 9 29 5 24C1 19 2 11 7 6C10 3 13 3 16 3Z" stroke="#EF4444" stroke-width="1.5" stroke-dasharray="2 1"/><path d="M8 6L3 2M24 6L29 2M26 24L30 28M6 24L2 28" stroke="#FDE047" stroke-width="1.5" stroke-linecap="round"/><circle cx="16" cy="16" r="2.8" fill="#FFFFFF" stroke="#00F0FF" stroke-width="1"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="refl-core-glow" cx="20" cy="10" r="14" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="35%" stop-color="#38BDF8"/><stop offset="70%" stop-color="#0284C7" stop-opacity="0.6"/><stop offset="100%" stop-color="#0F172A" stop-opacity="0"/></radialGradient></defs><path d="M4 28 C8 18 14 10 28 4 C32 10 24 22 4 28 Z" fill="url(#refl-core-glow)" stroke="#7DD3FC" stroke-width="0.8"/><circle cx="20" cy="10" r="3" fill="#FFFFFF"/><path d="M20 4V16M14 10H26" stroke="#BAE6FD" stroke-width="0.8"/><circle cx="8" cy="22" r="1.2" fill="#E0F2FE"/></svg>`
  },
  {
    id: 'bok-globule',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="bok-proto" cx="16" cy="16" r="3" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#F97316"/><stop offset="100%" stop-color="#7C2D12" stop-opacity="0"/></radialGradient></defs><g fill="#FFFFFF" opacity="0.8"><circle cx="3" cy="4" r="0.9"/><circle cx="9" cy="3" r="0.9"/><circle cx="25" cy="4" r="0.9"/><circle cx="29" cy="7" r="0.9"/><circle cx="30" cy="15" r="0.9"/><circle cx="28" cy="26" r="0.9"/><circle cx="23" cy="29" r="0.9"/><circle cx="5" cy="28" r="0.9"/><circle cx="2" cy="20" r="0.9"/><circle cx="2" cy="11" r="0.9"/></g><path d="M11 9C13 6 18 6 21 8C25 10 27 14 25 19C23 23 19 26 15 25C10 24 7 21 7 17C6 13 9 10 11 9Z" fill="#030712" stroke="#1E293B" stroke-width="1.8"/><circle cx="16" cy="16" r="3" fill="url(#bok-proto)"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="hh-jet-top" x1="16" y1="16" x2="16" y2="2" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#38BDF8"/><stop offset="100%" stop-color="#0284C7"/></linearGradient><linearGradient id="hh-jet-bot" x1="16" y1="16" x2="16" y2="30" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#F97316"/><stop offset="100%" stop-color="#EF4444"/></linearGradient></defs><line x1="16" y1="16" x2="16" y2="2" stroke="url(#hh-jet-top)" stroke-width="2.5" stroke-linecap="round"/><line x1="16" y1="16" x2="16" y2="30" stroke="url(#hh-jet-bot)" stroke-width="2.5" stroke-linecap="round"/><path d="M10 4C13 2 19 2 22 4" stroke="#00F0FF" stroke-width="1.8" stroke-linecap="round" fill="none"/><path d="M10 28C13 30 19 30 22 28" stroke="#EF4444" stroke-width="1.8" stroke-linecap="round" fill="none"/><circle cx="16" cy="16" r="4" fill="#FDE047" stroke="#F59E0B" stroke-width="1"/><circle cx="16" cy="16" r="2" fill="#FFFFFF"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="wr-star-glow" cx="16" cy="16" r="5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="none" stroke="#34D399" stroke-width="2.2"/><circle cx="16" cy="16" r="13" fill="none" stroke="#A7F3D0" stroke-width="0.8" stroke-dasharray="2 2"/><path d="M6 11C9 9 13 10 15 13M6 11C8 13 9 16 8 19" stroke="#6EE7B7" stroke-width="1.2" fill="none"/><path d="M26 11C23 9 19 10 17 13M26 11C24 13 23 16 24 19" stroke="#6EE7B7" stroke-width="1.2" fill="none"/><circle cx="16" cy="16" r="4.5" fill="url(#wr-star-glow)"/><circle cx="16" cy="16" r="2" fill="#FFFFFF"/></svg>`
  },
  {
    id: 'nova-ring',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="nova-exp-glow" cx="16" cy="16" r="13" gradientUnits="userSpaceOnUse"><stop offset="65%" stop-color="#FDE047" stop-opacity="0"/><stop offset="85%" stop-color="#FDE047" stop-opacity="0.9"/><stop offset="100%" stop-color="#EF4444" stop-opacity="0"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="url(#nova-exp-glow)"/><circle cx="16" cy="16" r="12" stroke="#FDE047" stroke-width="1.8"/><circle cx="16" cy="16" r="7.5" stroke="#F97316" stroke-width="1" stroke-dasharray="2 1.5"/><circle cx="13" cy="16" r="2.8" fill="#FFFFFF" stroke="#38BDF8" stroke-width="0.8"/><circle cx="21" cy="16" r="1.8" fill="#F59E0B"/><path d="M20 15C17 15 15 16 13.5 16" stroke="#FEF08A" stroke-width="0.8"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="cepheid-core" cx="16" cy="16" r="5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#FDE047"/><stop offset="100%" stop-color="#F97316"/></radialGradient></defs><circle cx="16" cy="16" r="13" fill="none" stroke="#FDE047" stroke-width="0.8" stroke-dasharray="2 2" opacity="0.6"/><circle cx="16" cy="16" r="9" fill="none" stroke="#F59E0B" stroke-width="1.2" stroke-dasharray="3 2"/><circle cx="16" cy="16" r="5" fill="url(#cepheid-core)"/><path d="M2 16 Q6 8 10 16 Q14 24 18 16 Q22 8 26 16 Q28 20 30 16" stroke="#EF4444" stroke-width="1.5" stroke-linecap="round" fill="none"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="runaway-star" cx="22" cy="16" r="4.5" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#38BDF8"/><stop offset="100%" stop-color="#1E3A8A"/></radialGradient></defs><path d="M8 3 C3 9 2 16 2 16 C2 16 3 23 8 29" stroke="#00F0FF" stroke-width="2.5" stroke-linecap="round" fill="none"/><path d="M12 6 C7 11 6 16 6 16 C6 16 7 21 12 26" stroke="#38BDF8" stroke-width="1.5" stroke-linecap="round" fill="none" opacity="0.75"/><line x1="22" y1="16" x2="2" y2="16" stroke="#FFFFFF" stroke-width="0.8" stroke-dasharray="2 1.5" opacity="0.5"/><circle cx="22" cy="16" r="4.5" fill="url(#runaway-star)"/></svg>`
  },
  ...
  // ── Phenomena & Events (7 new) ─────────────────────────────────────────────
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="lens-cluster" cx="16" cy="16" r="6" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#FDE047"/><stop offset="100%" stop-color="#D97706"/></radialGradient></defs><ellipse cx="16" cy="16" rx="6.5" ry="5" fill="url(#lens-cluster)"/><path d="M3 10 C6 3 15 1 20 5" stroke="#00F0FF" stroke-width="2.5" stroke-linecap="round" fill="none"/><path d="M29 10 C26 3 17 1 12 5" stroke="#00F0FF" stroke-width="2.5" stroke-linecap="round" fill="none"/><path d="M3 22 C6 29 15 31 20 27" stroke="#38BDF8" stroke-width="2.2" stroke-linecap="round" fill="none"/><path d="M29 22 C26 29 17 31 12 27" stroke="#38BDF8" stroke-width="2.2" stroke-linecap="round" fill="none"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="roche-planet" cx="8" cy="16" r="7" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#60A5FA"/><stop offset="60%" stop-color="#1D4ED8"/><stop offset="100%" stop-color="#0F172A"/></radialGradient></defs><circle cx="8" cy="16" r="7" fill="url(#roche-planet)" stroke="#93C5FD" stroke-width="0.8"/><line x1="15" y1="16" x2="30" y2="24" stroke="#F97316" stroke-width="0.8" stroke-dasharray="1.5 1.5"/><circle cx="18" cy="13" r="3.2" fill="#CBD5E1" stroke="#64748B" stroke-width="0.6"/><circle cx="22" cy="16" r="2.4" fill="#CBD5E1"/><circle cx="25" cy="19" r="1.8" fill="#94A3B8"/><circle cx="27" cy="22" r="1.2" fill="#64748B"/><circle cx="29" cy="25" r="0.8" fill="#475569"/></svg>`
  },
  {
    id: 'kilonova-flash',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="kn-explosion" cx="16" cy="16" r="12" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="30%" stop-color="#FDE047"/><stop offset="65%" stop-color="#F97316"/><stop offset="100%" stop-color="#7C2D12" stop-opacity="0"/></radialGradient></defs><circle cx="16" cy="16" r="12" fill="url(#kn-explosion)"/><path d="M16 16 L23 9 M16 16 L9 23" stroke="#FFFFFF" stroke-width="1.8" stroke-dasharray="2 1" stroke-linecap="round"/><circle cx="23" cy="9" r="2.8" fill="#E2E8F0" stroke="#00F0FF" stroke-width="0.8"/><circle cx="9" cy="23" r="2.8" fill="#E2E8F0" stroke="#00F0FF" stroke-width="0.8"/><path d="M2 26 C4 20 6 16 8 14 M24 2 C24 8 22 12 20 14" stroke="#FDE047" stroke-width="1.2" stroke-linecap="round" fill="none"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="grb-beam-top" x1="16" y1="16" x2="16" y2="1" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="40%" stop-color="#EF4444"/><stop offset="100%" stop-color="#7C2D12"/></linearGradient><linearGradient id="grb-beam-bot" x1="16" y1="16" x2="16" y2="31" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="40%" stop-color="#EF4444"/><stop offset="100%" stop-color="#7C2D12"/></linearGradient></defs><polygon points="16,16 11,1 21,1" fill="url(#grb-beam-top)"/><polygon points="16,16 11,31 21,31" fill="url(#grb-beam-bot)"/><ellipse cx="16" cy="16" rx="12" ry="4" fill="#FDE047" stroke="#F59E0B" stroke-width="0.8" opacity="0.75"/><circle cx="16" cy="16" r="4.5" fill="#030712" stroke="#EF4444" stroke-width="1.2"/><circle cx="16" cy="16" r="2" fill="#FFFFFF"/></svg>`
  },
  {
    id: 'fast-radio-burst',
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><radialGradient id="frb-core-glow" cx="16" cy="16" r="4" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FFFFFF"/><stop offset="50%" stop-color="#00F0FF"/><stop offset="100%" stop-color="#3B82F6"/></radialGradient></defs><circle cx="16" cy="16" r="14" stroke="#7DD3FC" stroke-width="0.8" fill="none" opacity="0.4"/><circle cx="16" cy="16" r="10.5" stroke="#38BDF8" stroke-width="1.2" fill="none" opacity="0.65"/><circle cx="16" cy="16" r="7" stroke="#00F0FF" stroke-width="1.8" fill="none"/><circle cx="16" cy="16" r="4" fill="url(#frb-core-glow)"/><path d="M2 10 L5 16 L8 10 L11 16 L14 10" stroke="#00F0FF" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="tde-stream" x1="26" y1="6" x2="8" y2="16" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FEF08A"/><stop offset="50%" stop-color="#F97316"/><stop offset="100%" stop-color="#EF4444"/></linearGradient></defs><circle cx="8" cy="16" r="7" fill="#030712" stroke="#A855F7" stroke-width="1.8"/><circle cx="8" cy="16" r="7" stroke="#00F0FF" stroke-width="0.8" stroke-dasharray="2 1.5"/><circle cx="26" cy="6" r="4" fill="#FDE047" stroke="#F59E0B" stroke-width="0.8"/><path d="M24 8 Q16 12 10 16 Q16 18 22 23" fill="none" stroke="url(#tde-stream)" stroke-width="2.5" stroke-linecap="round"/><circle cx="8" cy="16" r="2.5" fill="#FFFFFF"/></svg>`
  },
  {
    ...
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none"><defs><linearGradient id="string-line" x1="4" y1="28" x2="28" y2="4" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#00F0FF"/><stop offset="50%" stop-color="#A855F7"/><stop offset="100%" stop-color="#EC4899"/></linearGradient></defs><path d="M4 28 Q16 16 28 4" stroke="url(#string-line)" stroke-width="3" stroke-linecap="round"/><path d="M4 28 Q16 16 28 4" stroke="#FFFFFF" stroke-width="1" stroke-linecap="round"/><g fill="#FDE047"><circle cx="7" cy="9" r="1.5"/><circle cx="10" cy="6" r="1.5"/><circle cx="22" cy="26" r="1.5"/><circle cx="25" cy="23" r="1.5"/></g></svg>`
  }
