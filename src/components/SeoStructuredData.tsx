...
export const SeoStructuredData: React.FC = () => {
  const appSchema = {
    ...
    description:
      'A cohesive library of 134 pixel-perfect vector space SVG icons and a deterministic user avatar generator built for web apps, user dashboards, and gaming platforms.',
    ...
    featureList: [
      '134 Pixel-perfect 32x32 vector space SVG icons',
      'Deterministic seed hashing via FNV-1a algorithm with 5,628 core artwork signatures (90,000+ styled variations)',
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Cosmic Avatars is an open-source space SVG icon library and deterministic user avatar generator. It includes 134 vector space icons and instantly creates reproducible, visually unique cosmic avatars for any seed string (username, email, or user ID) with zero server load.',
        },
      },
      {
        '@type': 'Question',
